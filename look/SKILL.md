...
> "I don't have your design rules yet, so I can't check for brand drift. I'll still look for layout issues and obvious problems. Want me to set up your Design Bible first? Run `/dstack:context` — it takes 5 minutes and makes every future check much smarter."
...
After the run, append to `dstack/DESIGN-BIBLE.md` Memory Log:
